...
const Hm3f_R = () => {
  ...
  function onIntersect() {
    // 声明一个变量来表示是否碰撞
    let isCollide = false;
    const direction = camera.getWorldDirection(player.direction).normalize();
    ...
    const arrow = new THREE.ArrowHelper(
      raycaster.getWorldDirection,
      raycaster.getWorldPosition,
      100,
      0xff0000
    );
    ...
    // {
    //     "x": -5.252197265625,
    //     "y": 0.6055444478988647,
    //     "z": 1.2824735641479492
    // }
